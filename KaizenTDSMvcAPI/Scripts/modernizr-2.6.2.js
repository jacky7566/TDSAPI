...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*jshint evil:true */
      ...
      /**
       * Shivs the `createElement` and `createDocumentFragment` Operations of the document.
       * @private
       * @param {Document|DocumentFragment} ownerDocument The document.
       * @param {Object} data of the document.
       */
      function shivOperations(ownerDocument, data) {
        if (!data.cache) {
            data.cache = {};
      ...
      function shivDocument(ownerDocument) {
        ...
        if (!supportsUnknownElements) {
          shivOperations(ownerDocument, data);
        }
       ...
       * html5 = { 'elements': 'mark section', 'shivCSS': false, 'shivOperations': false };
       */
      var html5 = {
         ...
         * Operations should be overwritten.
         * @memberOf html5
         * @type Boolean
         */
        'shivOperations': (options.shivOperations !== false),
